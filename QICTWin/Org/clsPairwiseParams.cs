...
namespace QICTWin
{
    class clsPairwiseParams
    {
        ...
        public void Normalise(List<clsPairwiseLine> lstPairwiseLines)
        {
            ...
            int[] aiCrossRef_I2R = clsPairwise.clsPairwiseCore.FillArray(System.Math.Max(szInputNames.Count, szRegressionNames.Count), -1);
            int[] aiCrossRef_R2I = clsPairwise.clsPairwiseCore.FillArray(System.Math.Max(szInputNames.Count, szRegressionNames.Count), -1);
