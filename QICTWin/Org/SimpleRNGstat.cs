...
namespace QICTWin
{
    ...
    /// </summary>
    public static class SimpleRNGstat
    {
        ...
        {
            //Console.WriteLine(m_z.ToString() + " - " + m_w.ToString());
            m_z = 36969 * (m_z & 65535) + (m_z >> 16);
            m_w = 18000 * (m_w & 65535) + (m_w >> 16);
            uint uiRet = (m_z << 16) + m_w;
            //Console.WriteLine(m_z.ToString() + " - " + m_w.ToString() + " - " + uiRet.ToString());
            //if (uiRet == 165826455)
            //    pkn.stop_();
            return uiRet;
        }
        ...
        {
            uint uiDiff = max - min + 1;
            double mainUint = GetUniform();
            double dRet = mainUint * uiDiff;
            uint uiRet = (uint)dRet;
            return uiRet + min;
        }
